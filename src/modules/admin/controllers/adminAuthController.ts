...
export const adminSignup = async(req:Request<{},{},AdminSignupBody>,res:Response):Promise<void>=>{
    try {
...
export const adminLogin = async(req:Request<{},{},AdminLoginBody>,res:Response) : Promise<void> =>{
    try {
