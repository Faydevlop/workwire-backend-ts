...
export const resetPassRequest = async (req:Request,res:Response): Promise<void> =>{
    try {
        const {userId} = req.params
        ...
        const resetLink = `${process.env.FRONTENDAPI}${existUser.position}/reset-password?token=${token}`
